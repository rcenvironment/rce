...
public class ReadOnlyWorkflowNodePart extends WorkflowNodePart {
    ...
    public ReadOnlyWorkflowNodePart() {
        ...
        BatchAggregator.BatchProcessor<ComponentState> batchProcessor = new BatchAggregator.BatchProcessor<ComponentState>() {
        ...
        batchAggregator = new BatchAggregator<ComponentState>(MAX_BATCH_SIZE, MAX_BATCH_LATENCY_MSEC, batchProcessor);
    }
    ...
    private void initializeStatus() {
        try {
            ...
            final NodeIdentifier ctrlerNode = getWorkflowExecutionInformation().getNodeId();
