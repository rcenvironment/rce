 ...
 */
public class ConvergerForwardedEndpointSelectionPane extends EndpointSelectionPane {

    private final InputWithRelatedOuputSelectionPane outputPane;
    
    public ConvergerForwardedEndpointSelectionPane(String title, EndpointType direction, 
        WorkflowNodeCommand.Executor executor, boolean readonly,
        String id, InputWithRelatedOuputSelectionPane outputPane) {
        super(title, direction, executor, readonly, id, true);
