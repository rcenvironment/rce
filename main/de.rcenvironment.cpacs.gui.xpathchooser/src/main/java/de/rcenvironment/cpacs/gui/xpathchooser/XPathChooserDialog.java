...
public class XPathChooserDialog extends TitleAreaDialog {
    ...
    public void create() {
        ...
        if (getClass().getResourceAsStream("/resources/images/tree64.png") == null) {
            titleImage = new Image(parentShell.getDisplay(), "./resources/images/tree64.png");
        } else {
            titleImage = new Image(parentShell.getDisplay(), getClass().getResourceAsStream("/resources/images/tree64.png"));
        }
    ...
    protected void configureShell(final Shell shell) {
        ...
        if (getClass().getResourceAsStream("/resources/images/tree16.png") == null) {
            headImage = new Image(parentShell.getDisplay(), "./resources/images/tree16.png");
        } else {
            headImage = new Image(parentShell.getDisplay(), getClass().getResourceAsStream("/resources/images/tree16.png"));
        }
