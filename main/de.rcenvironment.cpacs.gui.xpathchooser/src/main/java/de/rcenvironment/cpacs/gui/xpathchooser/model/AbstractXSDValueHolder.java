...
public abstract class AbstractXSDValueHolder extends AbstractXSDTreeItem implements XSDValueHolder {
     ...
     * {@inheritDoc}
     *
     * @see de.rcenvironment.cpacs.gui.xpathchooser.model.XSDValueHolder#getValues()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see de.rcenvironment.cpacs.gui.xpathchooser.model.XSDValueHolder#setValues(java.util.List)
     */
    @Override
