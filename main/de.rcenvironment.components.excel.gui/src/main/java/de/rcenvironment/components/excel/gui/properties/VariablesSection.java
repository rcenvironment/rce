...
public class VariablesSection extends EndpointPropertySection {
    ...
    public VariablesSection() {
        ...
        VariablesSelectionPane inputPane =
            new VariablesSelectionPane(Messages.inputPaneName, EndpointType.INPUT, this,
                ExcelPropertiesConstants.ID_INPUT_PANE);
        VariablesSelectionPane outputPane =
            new VariablesSelectionPane(Messages.outputPaneName, EndpointType.OUTPUT, this,
                ExcelPropertiesConstants.ID_OUTPUT_PANE);
        setColumns(2);
