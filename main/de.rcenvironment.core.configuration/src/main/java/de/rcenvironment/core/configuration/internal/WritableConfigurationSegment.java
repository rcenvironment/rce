...
public interface WritableConfigurationSegment extends ConfigurationSegment {
    ...
    // void setString(String relativePath, String value);

    // void setInteger(String relativePath, Integer value);

    // void setFloat(String relativePath, Double value);

    // void setStringArray(String relativePath, List<String> value);

    // ConfigurationSegment createElement(String relativePath, String id);

    // void deleteElement(String relativePath, String id);
