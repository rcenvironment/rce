...
/**
 * Unit test for {@link AsyncOrderedCallbackManager}.
 * 
 * @author Robert Mischke
 */
public class AsyncOrderedCallbackManagerTest {
    ...
    public void testMultithreadedCallbackBehaviour() throws InterruptedException {
        AsyncOrderedCallbackManager<TestListener> callbackManager =
            new
            AsyncOrderedCallbackManager<TestListener>(SharedThreadPool.getInstance(),
