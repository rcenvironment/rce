...
/**
 * Tests for {@link InputProviderWorkflowNodeValidator}.
 *
 * @author Tobias Rodehutskors
 */
public class InputProviderWorkflowNodeValidatorTest {
    //
    ...
    //
    // // /**
    // // * Create and open a new project in the current workspace. Needed for all tests involving relative paths.
    // // *
    ...
    //
    // /**
    // * Set up a workflowNode with an end point of the specified data type and add the specified meta data value. Executes the validation
    // and
    // * return the validation messages.
    // */
    // private Collection<WorkflowNodeValidationMessage> testHelper(DataType endpointDataType, String metaDataValue) {
    // InputProviderWorkflowNodeValidator validator = new InputProviderWorkflowNodeValidator();
    //
    // WorkflowNode node = EasyMock.createStrictMock(WorkflowNode.class);
    // node.addPropertyChangeListener(EasyMock.anyObject());
    //
    // EndpointDescriptionsManager outputManager = EasyMock.createStrictMock(EndpointDescriptionsManager.class);
    // EndpointDescription endpoint = new EndpointDescription(null, "test");
    // endpoint.setDataType(endpointDataType);
    //
    // endpoint.setMetaDataValue(InputProviderComponentConstants.META_VALUE, metaDataValue);
    //
    ...
    //
    // ComponentDescription description = EasyMock.createStrictMock(ComponentDescription.class);
    // EndpointDescriptionsManager inputManager = EasyMock.createStrictMock(EndpointDescriptionsManager.class);
    // EasyMock.expect(inputManager.getEndpointDescriptions()).andReturn(new HashSet<EndpointDescription>());
    ...
    // Collection<WorkflowNodeValidationMessage> messages = validator.getMessages();
    //
    ...
    // // */
    // // private void createProjectAndFile(String fileName, String resource) throws CoreException {
    ...
    // */
    // private void expectOneErrorMessage(Collection<WorkflowNodeValidationMessage> messages) {
    // assertEquals(1, messages.size());
    // WorkflowNodeValidationMessage message = messages.toArray(new WorkflowNodeValidationMessage[1])[0];
    // assertEquals(WorkflowNodeValidationMessage.Type.ERROR, message.getType());
    // }
    //
    // /**
    ...
    // Collection<WorkflowNodeValidationMessage> messages = testHelper(DataType.FileReference, testFile.getAbsolutePath());
    //
    // // no error expected
    ...
    // //
    // // Collection<WorkflowNodeValidationMessage> messages = testHelper(DataType.FileReference, PROJECT_NAME + File.separator + fileName);
    // //
    // // // no error expected
    // // assertEquals(0, messages.size());
    // // }
    ...
    // //
    // // Collection<WorkflowNodeValidationMessage> messages = testHelper(DataType.FileReference, PROJECT_NAME + File.separator + dirName);
    // //
    // // expectOneErrorMessage(messages);
    // // }
    // //
    ...
    // // Collection<WorkflowNodeValidationMessage> messages = testHelper(DataType.FileReference, "fsadfsadfsadfds");
    // //
    // // expectOneErrorMessage(messages);
    // // }
    //
    ...
    // File testFile = TempFileServiceAccess.getInstance().createTempFileWithFixedFilename(TEST_FILE);
    // Collection<WorkflowNodeValidationMessage> messages = testHelper(DataType.DirectoryReference, testFile.getAbsolutePath());
    //
    // expectOneErrorMessage(messages);
    // }
    //
    ...
    // // testHelper(DataType.DirectoryReference, PROJECT_NAME + File.separator + fileName);
    // //
    // // expectOneErrorMessage(messages);
    // // }
    //
    ...
    // Collection<WorkflowNodeValidationMessage> messages = testHelper(DataType.DirectoryReference, testDir.getAbsolutePath());
    //
    // // no error expected
    // assertEquals(0, messages.size());
    // }
    ...
    // //
    // // Collection<WorkflowNodeValidationMessage> messages =
    // // testHelper(DataType.DirectoryReference, PROJECT_NAME + File.separator + dirName);
    // //
    // // // no error expected
    // // assertEquals(0, messages.size());
    // // }
