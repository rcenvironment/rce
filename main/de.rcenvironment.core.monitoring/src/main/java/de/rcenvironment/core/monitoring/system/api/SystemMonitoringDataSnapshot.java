 ...
 */
public class SystemMonitoringDataSnapshot implements Serializable {
    ...
    public SystemMonitoringDataSnapshot(double totalNodeCPUusage, long totalNodeRAMUsage, long totalNodeSystemRAM, double systemIdle,
    ...
    public boolean equals(Object obj) {
        ...
        SystemMonitoringDataSnapshot other = (SystemMonitoringDataSnapshot) obj;
        if (rceOwnProcesses == null) {
