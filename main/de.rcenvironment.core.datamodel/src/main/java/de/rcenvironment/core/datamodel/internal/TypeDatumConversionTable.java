 ...
 * @author Sascha Zur
 */
public final class TypeDatumConversionTable {
    ...
    private static final int[][] TABLE =
    {
        ...
        /* Empty_______ */{ NO_, NO_, NO_, NO_, NO_, NO_, NO_, UNS, NO_, NO_, NO_, NO_, NO_ },
        ...
        /* FileRef_____ */{ NO_, NO_, NO_, NO_, NO_, NO_, YES, NO_, NO_, NO_, NO_, NO_, NO_ },
    ...
    private TypeDatumConversionTable() {}
