...
public class XMLMapperImplTest {
    ...
    public void testWithNullValues() throws XMLException, XPathExpressionException {
        ...
        File nullFile = null;
        xmlMapper.transformXMLFileWithXMLMappingInformation(nullFile, nullFile, null);
        xmlMapper.transformXMLFileWithXMLMappingInformation(originCPACS, nullFile, null);
        xmlMapper.transformXMLFileWithXMLMappingInformation(nullFile, resultFile, null);
        xmlMapper.transformXMLFileWithXMLMappingInformation(nullFile, nullFile, mappingInputSimple);
        xmlMapper.transformXMLFileWithXMLMappingInformation(nullDoc, nullDoc, nullDoc);
