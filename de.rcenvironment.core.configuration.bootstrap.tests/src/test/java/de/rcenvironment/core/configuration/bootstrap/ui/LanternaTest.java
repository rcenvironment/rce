...
public class LanternaTest {
    ...
    private Log log = LogFactory.getLog(LanternaTest.class);

    public LanternaTest() {

        terminal = new TestTerminal(TERMINAL_WIDTH, TERMINAL_HEIGHT);
    ...
    void executeTests(boolean checkForGracefullShutdown) {
